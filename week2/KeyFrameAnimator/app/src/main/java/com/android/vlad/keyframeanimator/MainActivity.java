package com.android.vlad.keyframeanimator;
...
public class MainActivity extends Activity {
    ...
    private List<Animator> mFrames = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonSaveFrame = (Button) findViewById(R.id.save_frame);
        buttonSaveFrame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                mFrames.add(ObjectAnimator.ofPropertyValuesHolder(mImageView, translationX, translationY, scaleX, scaleY, rotation));
        ...
        buttonPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFrames.size() == 0) {
                    Toast.makeText(getApplicationContext(), "No frames saved!", Toast.LENGTH_SHORT).show();
                    return;
                }

                AnimatorSet animatorSet = new AnimatorSet();
                animatorSet.setDuration(ANIMATION_DURATION);
                animatorSet.playSequentially(mFrames);
                animatorSet.start();
            }
        });

        Button buttonClearFrames = (Button) findViewById(R.id.clear_frames);
        buttonClearFrames.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mFrames.clear();
                Toast.makeText(getApplicationContext(), "Frames cleared!", Toast.LENGTH_SHORT).show();
            }
        });
    }
